...
class TachesController extends AbstractController
{
    ...
    #[Route('/{id}/projet', name: 'app_article_tacheProjet', methods: ['GET'])]
    public function articlecategorie(TachesRepository $tacheRepository, Projets $projet): Response
    {
        return $this->render('article/kanban.html.twig', [
            'taches' => $tacheRepository->findByProjetId($projet)
        ]);
    }
}
